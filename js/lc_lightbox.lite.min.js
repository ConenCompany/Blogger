...
(function (b) {
  ...
  lcl_url_hash = "";
  lc_lightbox = function (k, C) {
    if ("string" != typeof k && ("object" != typeof k || !k.length)) return !1;
    var w = !1;
    b.each(lcl_objs, function (b, h) {
      if (JSON.stringify(h) == JSON.stringify(k)) return w = h, !1
    });
    if (!1 === w) {
      var v = new D(k, C);
      lcl_objs.push(v);
  ...
  lcl_destroy = function (k) {
    k = b.inArray(k, lcl_objs); - 1 !== k && lcl_objs.splice(k, 1)
  };
  var D = function (k, C) {
    var w = b.extend({
        gallery: !0,
    ...
    "string" == typeof k && (k = b(k));
    var l = b.data(k, "lcl_settings", w),
      h = b.data(k, "lcl_vars", v),
      z = function (b) {
      ...
      D = function (c) {
        var d = !1;
        b.each(h.elems, function (b, f) {
          if (f.hash == c) return d = f, !1
        });
        return d
      },
      B =
      ...
      E = function (c, d) {
        var e = l[d];
        return -1 !== e.indexOf("> ") ? c.find(e.replace("> ", "")).length ? b.trim(c.find(e.replace("> ", "")).html()) : "" : "undefined" != typeof c.attr(e) ? B(c.attr(e)) : ""
      },
      X = function (c) {
        var d = l,
          e = [];
        c.each(function () {
          ...
          if (!m) {
            m = g;
            var k = c.data("lcl-type");
            "undefined" == typeof k ? k = l.global_type : (m = m.toLowerCase(), k = /^(http|https)?:\/\/(?:[a-z\-]+\.)+[a-z]{2,6}(?:\/[^\/#?]+)+\.(?:jpe?g|gif|png)$/.test(m) ? "image" : "unknown");
            "unknown" != k ? (m = {
              src: g,
              type: k,
              ...
              width: "image" != k && "undefined" != typeof c.data("lcl-w") ?
                c.data("lcl-w") : !1,
              height: "image" != k && "undefined" != typeof c.data("lcl-h") ? c.data("lcl-h") : !1,
              force_over_data: "undefined" != typeof c.data("lcl-force-over-data") ? parseInt(c.data("lcl-force-over-data"), 10) : "",
              force_outer_cmd: "undefined" != typeof c.data("lcl-outer-cmd") ? c.data("lcl-outer-cmd") : ""
            }, m.download = "image" == k ? "undefined" != typeof c.data("lcl-path") ? c.data("lcl-path") : g : !1) : m = {
              src: g,
              type: k,
              hash: d.deeplink ? z(g) : !1
            }
      ...
      K = function () {
        ...
        0 < h.elem_index && y(!1, h.elem_index - 1);
        h.elem_index != h.elems.length - 1 && y(!1, h.elem_index + 1)
      },
      y = function (c, d, e) {
        var f = h;
      ...
      M = function (c, d) {
        ...
        if (f.is_arr_instance) {
          ...
          var m = c;
          e.live_elements && f.elems_selector && (m = d && e.gallery && e.gallery_hook && "undefined" != typeof b(k[0]).attr(e.gallery_hook) ? f.elems_selector + "[" + e.gallery_hook + "=" + d.attr(e.gallery_hook) + "]" : f.elems_selector, m = b(m));
          if (!X(m)) return (!e.live_elements || e.live_elements && !f.elems_selector) && console.error("LC Lightbox - no valid elements found"), !1
        }
        e.preload_all && !f.preload_all_used && (f.preload_all_used = !0, b(document).ready(function (c) {
          b.each(f.elems,
            function (b, c) {
              y(!1, b)
            })
        }));
        "function" == typeof e.elems_parsed && e.elems_parsed.call(null, l, h);
        f.is_arr_instance || (m = f.elems_selector ? b(f.elems_selector) : c, m.first().trigger("lcl_elems_parsed", [f.elems]));
        return !0
      };
    M(k);
    var G = function (c, d) {
        ...
        var e = l,
          f = h,
          g = "undefined" != typeof d ? d : !1;
        if (!h) return console.error("LC Lightbox - cannot open. Object not initialized"),
          !1;
        ...
        if (g) b.each(f.elems, function (b, c) {
          if (c.src == g.attr(e.src_attr)) return f.elem_index = b, !1
        });
      ...
      Y = function () {
        ...
        "function" == typeof c.html_is_ready && c.html_is_ready.call(null, l, h);
      ...
      ba = function (c) {
        ...
        d.addEventListener("touchstart", function (b) {
          1 === b.targetTouches.length && (e = b.targetTouches[0].clientY)
        }, !1);
      ...
      H = function (b) {
        return b.title || b.txt || b.author ? !0 : !1
      },
      O = function (c, d, e) {
        var f = 0,
          g = b("#lcl_wrap"),
      ...
      x = function (c, d, e) {
        ...
        var n = b(".lcl_force_txt_over").length || b(".lcl_hidden_txt").length || -1 === b.inArray(f.data_position, ["rside", "lside"]) || !H(c) ? 0 : b("#lcl_txt").outerWidth();
        var u = e || !b("#lcl_thumbs_nav").length || b(".lcl_tn_hidden").length ? 0 : b("#lcl_thumbs_nav").outerHeight(!0) - parseInt(b("#lcl_wrap").css("padding-bottom"), 10);
        ...
        p = e ? b(window).height() : Math.floor(O(p, "h")) - u;
        if ("object" == typeof g.txt_und_sizes) {
          if (q = g.txt_und_sizes.w, u = g.txt_und_sizes.h, "image" == c.type) var t = g.img_sizes_cache[c.src]
        } else switch (c.type) {
          case "image":
            b("#lcl_elem_wrap").css("bottom", 0);
            if ("undefined" == typeof g.img_sizes_cache[c.src]) return !1;
            t = g.img_sizes_cache[c.src];
            t.w <= q ? (q = t.w, u = t.h) : u = Math.floor(t.h / t.w * q);
            u >
              p && (u = p, q = Math.floor(t.w / t.h * u));
            if (H(c) && !b(".lcl_hidden_txt").length && "under" == f.data_position && "undefined" == typeof d.no_txt_under) return P(q, u, p), b(document).off("lcl_txt_und_calc").on("lcl_txt_und_calc", function () {
              if (g.txt_und_sizes) return "no_under" == g.txt_und_sizes && (d.no_txt_under = !0), x(g.elems[g.elem_index], d)
            }), !1;
        ...
        if (("rside" == f.data_position || "lside" == f.data_position) && !b(".lcl_no_txt").length && "undefined" == typeof d.side_txt_checked &&
          (t = "image" == c.type ? g.img_sizes_cache[c.src] : "", (p = c.force_over_data) || (p = 400), "image" == c.type && t.w > p && t.h > p && !ca(c, p, q + k, u + k, n))) return d.side_txt_checked = !0, x(c, d);
        g.txt_und_sizes = !1;
        if ("undefined" == typeof d.inner_cmd_checked && ("inner" == f.cmd_position || c.force_outer_cmd) && da(c, q)) return d.inner_cmd_checked = !0, x(c, d);
          ...
          if ("image" == c.type)
            if (b(".lcl_fullscreen_mode").length) {
              var d =
                t,
                e = l.fs_img_behavior;
              if (b(".lcl_fullscreen_mode").length && d.w <= b("#lcl_subj").width() && d.h <= b("#lcl_subj").height()) b(".lcl_image_elem").css("background-size", "auto");
              else if ("fit" == e) b(".lcl_image_elem").css("background-size", "contain");
              else if ("fill" == e) b(".lcl_image_elem").css("background-size", "cover");
              else if ("undefined" == typeof d) b(".lcl_image_elem").css("background-size", "cover");
              else {
    ...
    var P = function (c, d, e, f) {
        var g = "undefined" == typeof f ? 1 : f,
          k = b(".lcl_fullscreen_mode").length;
        ...
        lcl_txt_under_calc = setTimeout(function () {
          var m = Math.ceil(b("#lcl_txt").outerHeight()),
            p = d + m - e;
          if (k) return b("#lcl_wrap").removeClass("lcl_txt_under_calc"), b("#lcl_subj").css("maxHeight", "calc(100% - " + m + "px)"), h.txt_und_sizes = {
            w: c,
            h: d
          ...
          if (0 < p && ("undefined" == typeof f || 10 > f)) {
            ...
            q || (q = 400);
            return p < q || m < q ? (b("#lcl_wrap").removeClass("lcl_txt_under_calc").addClass("lcl_force_txt_over"), b("#lcl_subj").css("maxHeight", "none"), b("#lcl_txt").css({
              right: 0,
              width: "auto"
            }), h.txt_und_sizes = "no_under", b(document).trigger("lcl_txt_und_calc"), !0) : P(p, m, e, g + 1)
          }
      ...
      da = function (c, d) {
        var e = l,
          f = b(".lcl_fullscreen_mode").length ? !0 : !1;
      ...
      r = function (c, d) {
        ...
        if ("next" == c)
          if (e.elem_index == e.elems.length - 1) {
            if (!f) return !1;
            c = 0
          } else c = e.elem_index + 1;
        else if ("prev" == c)
          if (e.elem_index) c = e.elem_index - 1;
          else {
            if (!f) return !1;
            c = e.elems.length - 1
          }
        ...
        setTimeout(function () {
          ...
          "function" == typeof l.on_elem_switch && l.on_elem_switch.call(null, l, h, c);
      ...
      S = function (c) {
        ...
        lcl_pb_timeout = setTimeout(function () {
          b("#lcl_progressbar").stop(!0).removeAttr("style").css("width", 0).animate({
            width: "100%"
          }, e, "linear", function () {
      ...
      I = function () {
        if (!lcl_shown) return !1;
        "function" == typeof l.on_close && l.on_close.call(null, l, h);
      ...
      F = function (c, d) {
        ...
        "function" == typeof e.on_fs_enter && e.on_fs_enter.call(null, e, f);
      ...
      U = function (c) {
        ...
        "function" == typeof d.on_fs_exit && d.on_fs_exit.call(null, l, h);
          ...
          function (f, g) {
            if ("unknown" != g.type) {
              ...
              var k = "",
                n = "";
              tpc = "";
              if (g.thumb) n = g.thumb, k = "style=\"background-image: url('" + g.thumb + "');\"";
              else {
                switch (g.type) {
                  case "image":
                    n = g.src;
                    break;
                  case "youtube":
                    n = g.poster ? g.poster : "https://img.youtube.com/vi/" + g.video_id + "/maxresdefault.jpg";
                    break;
                  case "vimeo":
                    g.poster ? n = g.poster : "undefined" == typeof h.vimeo_thumb_cache[g.src] ? (tpc = "lcl_tn_preload", b.getJSON("https://www.vimeo.com/api/v2/video/" + g.video_id + ".json?callback=?", {
                        format: "json"
                      },
                      function (c) {
                  ...
                  case "html":
                    ...
                    break;
                  case "dailymotion":
                    n = g.poster ? g.poster : "http://www.dailymotion.com/thumbnail/video/" + g.video_id
                }
                n && (l.thumbs_maker_url && (g.poster || -1 === b.inArray(g.type, ["youtube",
                  "vimeo", "dailymotion"
                ])) && (n = l.thumbs_maker_url.replace("%URL%", encodeURIComponent(n)).replace("%W%", l.thumbs_w).replace("%H%", l.thumbs_h)), k = "style=\"background-image: url('" + n + "');\"", -1 === b.inArray(g.type, ["youtube", "vimeo", "dailymotion"]) || g.poster || (h.elems[f].vid_poster = n))
              }
              if (("html" == g.type || "iframe" == g.type) && !k) return !0;
              var u = "video" != g.type || k ? "" : '<video src="' + g.src + '"></video>';
              tpc = "lcl_tn_preload";
      ...
      W = function () {
        var c = 0;
        b(".lcl_tn_inner > li").each(function () {
    ...
    var R = function (c) {
      ...
      var e = 0;
      b(".lcl_tn_inner > li").each(function (d, f) {
        if (b(this).attr("rel") == c) return e = d, !1
      });
      ...
      b(".lcl_tn_inner").stop(!0).animate({
        ...
        b(".lcl_tn_inner").trigger("lcl_smoothscroll_end");
        b("#lcl_thumbs_nav").removeClass("lcl_pre_tn_scroll")
      });
    ...
    b.fn.lcl_smoothscroll = function (c, d, e, f) {
      ...
      var g = this,
        h = "undefined" != typeof e && e ? !1 : !0,
        k = "undefined" != typeof f && f ? !1 : !0,
        l = !1,
        p = !1,
        q = 0,
        r = 0,
      ...
      g.mousemove(function (b) {
        !0 === p && (g.stop(!0), h && g.scrollLeft(v + (r - b.pageX)), k && g.scrollTop(t + (q - b.pageY)))
      });
      ...
      g.mouseup(function (e) {
        ...
        if (20 < l || 20 < n) e = {}, k && (e.scrollTop = f), h && (e.scrollLeft = m), g.stop(!0).animate(e, d, "linear", function () {
          g.trigger("lcl_smoothscroll_end")
        })
      })
    };
    if (!v.is_arr_instance)
      if (w.live_elements && v.elems_selector) b(document).off("click", v.elems_selector).on("click", v.elems_selector, function (c) {
        c.preventDefault();
        b.data(k, "lcl_vars").elems_count = b(v.elems_selector).length;
        G(k, b(this));
    ...
    b(document).bind("keydown",
      function (c) {
        if (lcl_shown) {
          if (k != lcl_curr_obj) return !0;
          39 == c.keyCode ? (c.preventDefault(), r("next")) : 37 == c.keyCode ? (c.preventDefault(), r("prev")) : 27 == c.keyCode ? (c.preventDefault(), I()) : 122 == c.keyCode && l.fullscreen && ("undefined" != typeof lcl_fs_key_timeout && clearTimeout(lcl_fs_key_timeout), lcl_fs_key_timeout = setTimeout(function () {
            b(".lcl_fullscreen_mode").length ? U() : F()
          }, 50))
        }
      });
    b(document).on("wheel", "#lcl_overlay, #lcl_window, #lcl_thumbs_nav:not(.lcl_tn_has_arr)", function (c) {
      ...
      if (d.is("#lcl_window") || d.parents("#lcl_window").length) {
        var e = !0;
        for (a = 0; 20 > a && !d.is("#lcl_window"); a++)
          if (d[0].scrollHeight > d.outerHeight()) {
            e = !1;
            break
          } else d = d.parent();
    ...
    b(document).on("click", ".lcl_socials", function (c) {
      ...
      if (b(".lcl_socials > div").length) b(".lcl_socials_tt").removeClass("lcl_show_tt"),
        setTimeout(function () {
          b(".lcl_socials").removeClass("lcl_socials_shown").empty()
        }, 260);
      else {
        ...
        var e = encodeURIComponent(d.title).replace(/'/g, "\\'"),
          f = encodeURIComponent(d.txt).replace(/'/g, "\\'");
        if ("image" == d.type) var g = d.src;
        else g = d.poster ? d.poster : !1, g || "undefined" == typeof d.vid_poster || (g = d.vid_poster);
        var h = '<div class="lcl_socials_tt lcl_tooltip lcl_tt_bottom">';
        if (lcl_curr_opts.fb_share_params) {
          var l =
            c + (-1 === window.location.href.indexOf("?") ? "%3F" : "%26");
          l += encodeURIComponent(lcl_curr_opts.fb_share_params.replace("%TITLE%", e).replace("%DESCR%", f).replace("%IMG%", g));
          h += '<a class="lcl_icon lcl_fb" onClick="window.open(\'https://www.facebook.com/sharer?u=' + l + "&display=popup','sharer','toolbar=0,status=0,width=590,height=500');\" href=\"javascript: void(0)\"></a>"
        } else h += '<a class="lcl_icon lcl_fb" onClick="window.open(\'https://www.facebook.com/sharer?u=' + c + "&display=popup','sharer','toolbar=0,status=0,width=590,height=325');\" href=\"javascript: void(0)\"></a>";
        h += '<a class="lcl_icon lcl_twit" onClick="window.open(\'https://twitter.com/share?text=Check%20out%20%22' + e + "%22%20@&url=" + c + "','sharer','toolbar=0,status=0,width=548,height=325');\" href=\"javascript: void(0)\"></a>";
        lcl_on_mobile && (h += '<br/><a class="lcl_icon lcl_wa" href="whatsapp://send?text=' + c + '" data-action="share/whatsapp/share"></a>');
        g && (h += '<a class="lcl_icon lcl_pint" onClick="window.open(\'http://pinterest.com/pin/create/button/?url=' + c + "&media=" + encodeURIComponent(g) + "&description=" +
          e + "','sharer','toolbar=0,status=0,width=575,height=330');\" href=\"javascript: void(0)\"></a>");
        h += "</div>";
        b(".lcl_socials").addClass("lcl_socials_shown").html(h);
        setTimeout(function () {
          b(".lcl_socials_tt").addClass("lcl_show_tt")
        }, 20);
        if (lcl_curr_opts.fb_direct_share) b(document).off("click", ".lcl_fb").on("click", ".lcl_fb", function (b) {
          FB.ui({
    ...
    b(document).on("click", ".lcl_thumbs_toggle", function (c) {
      ...
      setTimeout(function () {
          b("#lcl_wrap").removeClass("lcl_toggling_tn")
        }, lcl_curr_opts.animation_time +
        50)
    });
    w = lcl_on_mobile ? " click" : "";
    b(document).on("lcl_tn_elem_click" + w, ".lcl_tn_inner > li", function (c) {
      if (k != lcl_curr_obj) return !0;
      c = b(this).attr("rel");
      r(c)
    });
    b(document).on("click", ".lcl_tn_prev:not(.lcl_tn_disabled_arr)", function (c) {
      if (k != lcl_curr_obj) return !0;
      b(".lcl_tn_inner").stop(!0).animate({
        scrollLeft: b(".lcl_tn_inner").scrollLeft() - lcl_curr_opts.thumbs_w - 10
      }, 300, "linear", function () {
        b(".lcl_tn_inner").trigger("lcl_smoothscroll_end")
      })
    });
    ...
    b(document).on("wheel", "#lcl_thumbs_nav.lcl_tn_has_arr", function (c) {
      if (k != lcl_curr_obj) return !0;
      c.preventDefault();
      0 < c.originalEvent.deltaY ? b(".lcl_tn_prev:not(.lcl_tn_disabled_arr)").trigger("click") : b(".lcl_tn_next:not(.lcl_tn_disabled_arr)").trigger("click")
    });
    ...
    var Z = function () {
        ...
        new AlloyFinger(c, {
          singleTap: function (c) {
            "lcl_overlay" != b(c.target).attr("id") ||
              l.modal || lcl_close()
          },
          ...
          touchStart: function (b) {
            lcl_touchstartX = b.changedTouches[0].clientX
          },
          touchEnd: function (c) {
            var d = lcl_touchstartX -
      ...
      A = function () {
        ...
        return h ? !0 : (console.error("LC Lightbox. Object not initialized"),
          !1)
      };
    ...
    lcl_resize = function () {
      if (!lcl_shown || lcl_is_active || !A()) return !1;
      var c = h;
      "undefined" != typeof lcl_size_check && clearTimeout(lcl_size_check);
      lcl_size_check = setTimeout(function () {
        b("#lcl_wrap").addClass("lcl_is_resizing");
        J();
        return x(c.elems[c.elem_index])
      }, 20)
    };
    lcl_close = function () {
      return lcl_shown && !lcl_is_active && A() ? I() : !1
    };
    lcl_switch = function (b) {
      return lcl_shown && !lcl_is_active && A() ? r(b) : !1
    };
    lcl_start_slideshow = function (c) {
      if (!lcl_shown || "undefined" == typeof c && "undefined" != typeof lcl_slideshow || !A()) return !1;
      var d = l;
      if (!d.carousel && h.elem_index == h.elems.length - 1) return !1;
      ...
      "undefined" == typeof c && ("function" == typeof d.slideshow_start && d.slideshow_start.call(null, d, h), h.is_arr_instance || (h.elems_selector ? b(h.elems_selector) : lcl_curr_obj).first().trigger("lcl_slideshow_start", [e]));
      return !0
    };
    lcl_stop_slideshow = function () {
      if (!lcl_shown || "undefined" == typeof lcl_slideshow || !A()) return !1;
      var c = l;
      if (!c) return console.error("LC Lightbox. Object not initialized"), !1;
      clearInterval(lcl_slideshow);
      lcl_slideshow = void 0;
      b("#lcl_wrap").removeClass("lcl_is_playing");
      b("#lcl_progressbar").stop(!0).animate({
        marginTop: -3 * b("#lcl_progressbar").height()
      }, 300, function () {
        b(this).remove()
      });
      "function" == typeof c.slideshow_end && c.slideshow_end.call(null, l, h);
